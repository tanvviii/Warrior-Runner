...
FONT_STYLE = "dino_runner/assets/Fonts/m42.ttf"
pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))

# Music Assets
LOOP_GAME = pygame.mixer.music.load("dino_runner/assets/Musics/loop_game.mp3")
LOOP_MENU = pygame.mixer.Sound("dino_runner/assets/Musics/loop_menu.mp3")
JUMP_SOUND = pygame.mixer.Sound("dino_runner/assets/Musics/jumpSound.mp3")
HIT_SOUND = pygame.mixer.Sound("dino_runner/assets/Musics/hitSound.mp3")
SLASH_GOBLIN = pygame.mixer.Sound("dino_runner/assets/Musics/slashGoblin.wav")
SLASH_BIRD = pygame.mixer.Sound("dino_runner/assets/Musics/slashBird.wav")
SLASH_SKELETON = pygame.mixer.Sound("dino_runner/assets/Musics/slashSkeleton.wav")
GAME_OVER = pygame.mixer.Sound("dino_runner/assets/Musics/gameOverHit.wav")
LIFE_UP = pygame.mixer.Sound("dino_runner/assets/Musics/lifeUp.wav")
...
HEARTS = [
    pygame.image.load(os.path.join(IMG_DIR, 'Interface/Hearts_2.png')).convert_alpha(),
    pygame.image.load(os.path.join(IMG_DIR, 'Interface/Hearts_1.png')).convert_alpha(),
    pygame.image.load(os.path.join(IMG_DIR, 'Interface/Hearts_0.png')).convert_alpha(),
]
