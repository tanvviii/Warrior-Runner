...
from warrior_runner.components.obstacles.skeleton import Skeleton
from warrior_runner.components.obstacles.bird import Bird
from warrior_runner.components.obstacles.goblin import Goblin
    ...
    def update(self, game):
        ...
        for obstacle in self.obstacles:
            ...
            if game.player.mask.overlap(obstacle.mask,
                ...
                if not game.player.has_power_ups and game.lives_left > game.last_life:
                    ...
                    self.obstacles.remove(obstacle)
                    game.player.reset_warrior_state()
            ...
            if game.lives_left == game.last_life:
                game.player.die()
